...
namespace UPM_IPS.DNRDPVSQGProyectoMDD
{
	...
	/// </remarks>
	public partial class DNRDPVSQGProyectoMDDToolboxHelper : DNRDPVSQGProyectoMDDToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new DNRDPVSQGProyectoMDDToolboxHelper.
		/// </summary>
		public DNRDPVSQGProyectoMDDToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	public abstract class DNRDPVSQGProyectoMDDToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify DNRDPVSQGProyectoMDD toolbox items.  
		/// </summary>
		/// <remarks>
		/// See the MSDN documentation for the ToolboxItemFilterAttribute class for more information on toolbox
		/// item filters.
		/// </remarks>
		public const string ToolboxFilterString = "DNRDPVSQGProyectoMDD.1.0";
		/// <summary>
		/// Toolbox item filter string used to identify RelacionToolbox connector tool.
		/// </summary>
		public const string RelacionToolboxFilterString = "RelacionToolbox.1.0";
		...
		/// <summary>
		/// Constructs a new DNRDPVSQGProyectoMDDToolboxHelperBase.
		/// </summary>
		protected DNRDPVSQGProyectoMDDToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
		...
		public static string DefaultToolboxTabName
		{
			get
			{
				return global::UPM_IPS.DNRDPVSQGProyectoMDD.DNRDPVSQGProyectoMDDDomainModel.SingletonResourceManager.GetString("VentanasToolboxTab", global::System.Globalization.CultureInfo.CurrentUICulture);
			}
		}
		...
		protected DslModeling::Store ToolboxStore
		{
			...
			{ 
				if (toolboxStore==null)
				{
					...
					toolboxStore.LoadDomainModels(typeof(global::UPM_IPS.DNRDPVSQGProyectoMDD.DNRDPVSQGProyectoMDDDomainModel));
