...
namespace UPM_IPS.DNRDPVSQGProyectoMDD
{
	...
	/// </remarks>
	public partial class DNRDPVSQGProyectoMDDHelpKeywordHelper : DNRDPVSQGProyectoMDDHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new DNRDPVSQGProyectoMDDHelpKeywordHelper.
		/// </summary>
		protected DNRDPVSQGProyectoMDDHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the DNRDPVSQGProyectoMDDHelpKeywordHelper.
		/// </summary>
		public static DNRDPVSQGProyectoMDDHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class DNRDPVSQGProyectoMDDHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new DNRDPVSQGProyectoMDDHelpKeywordHelperBase.
		/// </summary>
		protected DNRDPVSQGProyectoMDDHelpKeywordHelperBase()
			: base() { }
