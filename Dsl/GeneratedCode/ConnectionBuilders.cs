...
namespace UPM_IPS.DNRDPVSQGProyectoMDD
{
	...
	/// </summary>
	public static partial class RelacionAccionBuilder
	{
		...
		public static bool CanAcceptSource(DslModeling::ModelElement candidate)
		{
			...
			else if (candidate is global::UPM_IPS.DNRDPVSQGProyectoMDD.ComponenteAccion)
			{ 
				return true;
			}
			else
		...
		{
			if (candidate == null) return false;
			else if (candidate is global::UPM_IPS.DNRDPVSQGProyectoMDD.Objetivo)
			{ 
				return true;
			}
			else
		...
		public static bool CanAcceptSourceAndTarget(DslModeling::ModelElement candidateSource, DslModeling::ModelElement candidateTarget)
		{
			...
			{
				if (candidateSource is global::UPM_IPS.DNRDPVSQGProyectoMDD.ComponenteAccion)
				{
					if (candidateTarget is global::UPM_IPS.DNRDPVSQGProyectoMDD.Objetivo)
					{
						global::UPM_IPS.DNRDPVSQGProyectoMDD.ComponenteAccion sourceComponenteAccion = (global::UPM_IPS.DNRDPVSQGProyectoMDD.ComponenteAccion)candidateSource;
						global::UPM_IPS.DNRDPVSQGProyectoMDD.Objetivo targetObjetivo = (global::UPM_IPS.DNRDPVSQGProyectoMDD.Objetivo)candidateTarget;
						if(sourceComponenteAccion == null || global::UPM_IPS.DNRDPVSQGProyectoMDD.RelacionAccion.GetLinkToObjetivo(sourceComponenteAccion) != null) return false;
						if(targetObjetivo == null || sourceComponenteAccion == null || global::UPM_IPS.DNRDPVSQGProyectoMDD.RelacionAccion.GetLinks(sourceComponenteAccion, targetObjetivo).Count > 0) return false;
						return true;
					}
				}
		...
		public static DslModeling::ElementLink Connect(DslModeling::ModelElement source, DslModeling::ModelElement target)
		{
			...
			{
				if (source is global::UPM_IPS.DNRDPVSQGProyectoMDD.ComponenteAccion)
				{
					if (target is global::UPM_IPS.DNRDPVSQGProyectoMDD.Objetivo)
					{
						global::UPM_IPS.DNRDPVSQGProyectoMDD.ComponenteAccion sourceAccepted = (global::UPM_IPS.DNRDPVSQGProyectoMDD.ComponenteAccion)source;
						global::UPM_IPS.DNRDPVSQGProyectoMDD.Objetivo targetAccepted = (global::UPM_IPS.DNRDPVSQGProyectoMDD.Objetivo)target;
						DslModeling::ElementLink result = new global::UPM_IPS.DNRDPVSQGProyectoMDD.RelacionAccion(sourceAccepted, targetAccepted);
	...
	/// </summary>
	internal partial class RelacionToolboxConnectAction : DslDiagrams::ConnectAction
	{
		private DslDiagrams::ConnectionType[] connectionTypes;
		
		/// <summary>
		/// Constructs a new RelacionToolboxConnectAction for the given Diagram.
		/// </summary>
		public RelacionToolboxConnectAction(DslDiagrams::Diagram diagram): base(diagram, true) 
		{
		}
		...
		/// <summary>
		/// Returns the RelacionToolboxConnectionType associated with this action.
		/// </summary>
		protected override DslDiagrams::ConnectionType[] GetConnectionTypes(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement)
		{
			...
			{
				this.connectionTypes = new DslDiagrams::ConnectionType[] { new RelacionToolboxConnectionType() };
			}
			
			return this.connectionTypes;
		}
		
		private partial class RelacionToolboxConnectionTypeBase : DslDiagrams::ConnectionType
		{
			/// <summary>
			/// Constructs a new the RelacionToolboxConnectionType with the given ConnectionBuilder.
			/// </summary>
			protected RelacionToolboxConnectionTypeBase() : base() {}
			...
			/// </summary>
			/// <remarks>
			/// This implementation delegates calls to the ConnectionBuilder RelacionAccionBuilder.
			/// </remarks>
			public override bool CanCreateConnection(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement, ref string connectionWarning)
			{
				...
				{				
					if(targetShapeElement == null)
					{
						return RelacionAccionBuilder.CanAcceptSource(sourceElement);
					}
					else
					{				
						return RelacionAccionBuilder.CanAcceptSourceAndTarget(sourceElement, targetElement);
					}
				}
				else
				{
			...
			public override void CreateConnection(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement, DslDiagrams::PaintFeedbackArgs paintFeedbackArgs)
			{
				...
				if(targetElement == null) targetElement = targetShapeElement;
				RelacionAccionBuilder.Connect(sourceElement, targetElement);
			}
		}
		
		private partial class RelacionToolboxConnectionType : RelacionToolboxConnectionTypeBase
		{
			/// <summary>
			/// Constructs a new the RelacionToolboxConnectionType with the given ConnectionBuilder.
			/// </summary>
			public RelacionToolboxConnectionType() : base() {}
		}
	}
}
